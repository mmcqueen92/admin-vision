...
import { count } from '../fn/user-controller/count';
import { Count$Params } from '../fn/user-controller/count';
import { create } from '../fn/user-controller/create';
import { Create$Params } from '../fn/user-controller/create';
import { deleteById } from '../fn/user-controller/delete-by-id';
import { DeleteById$Params } from '../fn/user-controller/delete-by-id';
import { find } from '../fn/user-controller/find';
import { Find$Params } from '../fn/user-controller/find';
import { findById } from '../fn/user-controller/find-by-id';
import { FindById$Params } from '../fn/user-controller/find-by-id';
import { Count as LoopbackCount } from '../models/loopback/count';
import { replaceById } from '../fn/user-controller/replace-by-id';
import { ReplaceById$Params } from '../fn/user-controller/replace-by-id';
import { updateAll } from '../fn/user-controller/update-all';
import { UpdateAll$Params } from '../fn/user-controller/update-all';
import { updateById } from '../fn/user-controller/update-by-id';
import { UpdateById$Params } from '../fn/user-controller/update-by-id';
...
export class UserControllerService extends BaseService {
   ...
   * This method doesn't expect any request body.
   */
  findById$Response(params: FindById$Params, context?: HttpContext): Observable<StrictHttpResponse<UserWithRelations>> {
   ...
   * This method doesn't expect any request body.
   */
  findById(params: FindById$Params, context?: HttpContext): Observable<UserWithRelations> {
   ...
   * This method doesn't expect any request body.
   */
  find$Response(params?: Find$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<UserWithRelations>>> {
   ...
   * This method doesn't expect any request body.
   */
  find(params?: Find$Params, context?: HttpContext): Observable<Array<UserWithRelations>> {
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  create$Response(params?: Create$Params, context?: HttpContext): Observable<StrictHttpResponse<User>> {
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  create(params?: Create$Params, context?: HttpContext): Observable<User> {
